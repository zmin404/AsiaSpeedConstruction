(function($) {
    ...
    function set_stars() {
        $('ul#feedback-stars li i').css('background-image', 'url(' + ajax_window.plugin_url + '/frontend/v2/dist/img/feedback-star.svg)');
        $('ul#feedback-stars li.selected i').css('background-image', 'url(' + ajax_window.plugin_url + '/v2/frontend/dist/img/feedback-star-filled.svg)');
    }
})(jQuery);