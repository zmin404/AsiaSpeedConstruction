export default {
                        ...
                        <div class="modal-body order-modal__body">
                            <div class="ccb-order-data-details main">
                                ...
                                <div class="ccb-order-payment">
                                    Payment Method:
                                    <i v-if="order.paymentMethod !== 'no_payments' && order.paymentMethod" :class="['ccb-payment-icon', paymentMethod]"></i> 
    ...
    computed: {
        ...
        paymentMethodCondition() {
            return this.order.paymentMethod !== 'no_payments' && this.order.paymentMethod
        },

        paymentMethod() {
            return this.paymentMethodCondition ? this.order.paymentMethod : 'No payment'
        },
    }
}
