	...
	<div class="list-row">
		...
		<div>
			...
			<div class="list-content">
				...
				$desc_link = sprintf(
					wp_kses(
						__( 'Connection shortcode for linking a selling service or product to online payment systems. %s will be changed into total. <a href="%s">Read more</a>', 'cost-calculator-builder' ), // phpcs:ignore
						array( 'a' => array( 'href' => array() ) ) // phpcs:ignore
					),
					'[ccb-total-0]',
					esc_url( $desc_url )
				);
