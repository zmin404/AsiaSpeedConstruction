<?php echo \cBuilder\Classes\CCBTemplate::load( '/admin/partials/feedback' ); // phpcs:ignore ?>
		...
		<div class="ccb-panel-wrapper">
			<div class="left">
				<a href="<?php echo esc_url( get_admin_url() . 'admin.php?page=cost_calculator_builder' ); ?>" class="left-logo-wrapper">
					<span>
						<img src="<?php echo esc_url( CALC_URL . '/frontend/v1/dist/img/icon-100x100.png' ); ?>">
					</span>
				...
				<?php if ( ! get_option( 'ccb_feedback_added', false ) ) { ?>
					<a href="#" class="ccb-feedback-button">
						...
						<img src="<?php echo esc_url( CALC_URL . '/frontend/v1/dist/img/feedback.svg' ); ?>">
					</a>
				<?php } ?>
			</div>
			<div class="right">
