		...
		<div class="ccb-wrapper ccb-wrapper-<?php echo esc_attr( $calc_id ); ?>">
			<div class="custom-content-wrapper">
				<div class="ccb-page-contents">
					<?php echo \cBuilder\Classes\CCBTemplate::load( '/admin/partials/preview' ); //phpcs:ignore ?>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="ccb-accordion__item ccb-js-accordion-item" v-for="(value, index) in field.fields">
								...
								<div class="ccb-accordion-body ccb-js-accordion-body">
									<div class="ccb-accordion-body__contents">
										...
										<template v-else>
											<component v-bind:is="value.type + '-field'" v-bind:index="index" @change="storeStyles" v-bind:element="field" v-bind:data="field.fields" v-bind:field="value"></component>
										</template>
									</div>
								</div>
							</div>
